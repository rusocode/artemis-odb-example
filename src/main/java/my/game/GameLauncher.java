...
public class GameLauncher {
	...
	public static void main(String[] args) {
		...
		/*
		 * world.process itera sobre cada sistema, las suscripciones solo se actualizan justo antes y despues de que se ejecuta un sistema, y
		 * se congelan mientras un sistema procesa.
		 * */
